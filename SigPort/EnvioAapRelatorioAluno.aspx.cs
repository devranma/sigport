        ...
        protected void btnConfirmar_Click(object sender, EventArgs e)
        {
            ...
            if (!fuArquivoAAP.PostedFile.FileName.Equals(String.Empty))
            {
                ...
                if (aldao.ValidaIntegrantesGrupo(ras, nomes))
                {
                    if (!aap_enviada)
                    {
                        if (aldao.VerificaAlunosAAP(ras, nomes, selecionarAapeRelatorio.Text, Session["nomemateria"].ToString()))
                        {
                            if (aldao.InserirAAP(ras, nomes, selecionarAapeRelatorio.Text, ref mensagem, codigo_aluno) && (!mensagem.Equals("")))
                            {
                    ...
                    {
                        aldao.InserirAAP(ras, nomes, selecionarAapeRelatorio.Text, ref mensagem, codigo_aluno);
